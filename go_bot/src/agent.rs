...
mod tests {
    ...
    fn test_is_point_an_eye() {
        ...
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 2), White),
            false
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(4, 1), Black),
            false
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 1), White),
            false
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 3), White),
            true
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 3), Black),
            false
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 5), White),
            true
        );
        assert_eq!(
            is_point_an_eye(&board, Point::new(5, 5), Black),
            false
        );
    }
}
